import { Copy, Trash2, Download, Sun, Moon, HelpCircle, FileText, Upload, FileSpreadsheet, Layout, Palette, RefreshCcw, Menu, X, Settings } from 'lucide-react';
      ...
      {menuOpen && (
        <div className={clsx(
          ...
          <div className="p-3 space-y-1">
            ...
            <button
              onClick={() => { onDownloadMarkdown(); closeMenu(); }}
              className={clsx(
                "w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left transition-all duration-200",
                isDark
                  ? "text-gray-300 hover:bg-gray-700 hover:text-white"
            ...
            >
              <FileText className="w-5 h-5" />
              <span className="text-base">下载 Markdown</span>
            </button>
            <button
